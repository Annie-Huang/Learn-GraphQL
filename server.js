...
const AuthorType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    // How to get the a list of books written by the author:
    books: {
...
const RootQueryType = new GraphQLObjectType({
  ...
  fields: () => ({
    book: {
      ...
      // Defined the args type that should pass in if we want to search for a single book
      args: {
        id: { type: GraphQLInt },
      },
    ...
    author: {
      ...
      // Defined the args type that should pass in if we want to search for a single author
      args: {
        id: { type: GraphQLInt },
      },
      resolve: (parent, args) =>
